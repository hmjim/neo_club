...
preg_match_all( "/(https:\/\/neo-club.one).*\.(css|jpg|ico|svg|png|js|jpeg|webp|swf|gif|woff2|woff|ttf|pdf)/m", $contents, $urls_delim );
...
// if ( file_exists( $cachefile ) ) {
	...
	// jQuery(document).ready(function($) {
		...
		// jQuery.post( "https://neo-club.one/neoclub.php", data, function(response) {
			// if(response == 0){
